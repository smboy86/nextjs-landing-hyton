...
const Intro_video = () => {
	...
	return (
		<>
			...
			<div className="relative mx-auto max-w-[90rem]">
				...
				<div className="container">
					<figure className="relative overflow-hidden rounded-3xl before:absolute before:inset-0 before:bg-jacarta-900/25">
						<img src="/images/nft-game/nft_game_video_poster.jpg" className="w-full" alt="video" />
						<button
			...
			{/* <!-- end intro video --> */}
			{/* <!-- YouTube Video Modal --> */}
			<div className={videoModal ? 'modal lightbox fade show block' : 'modal lightbox fade'}>
